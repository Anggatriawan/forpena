...
try {
    ...
    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        if ($data) {
            ...
            echo "<h1 class='text-center'>Berikut Detail Permohonan Nama Anda</h1>";
            echo "<table class='table table-bordered table-striped mt-4'>";
            echo "<thead class='thead-dark'>";
            echo "<tr>";
            echo "<th>Nama Lama</th>";
            echo "<th>Nama Baru</th>";
            ...
            echo "<td><a href='download_diri.php?id=" . htmlspecialchars($data['id']) . "' class='btn btn-primary btn-sm download-btn'>Download</a></td>";
            echo "</tr>";
            echo "</tbody>";
            echo "</table>";
            echo "</div>";
    ...
    echo "<p>Buku Panduan Pendaftaran perkara elektronik, klik <a href='/forpena/buku_panduan/ecourt.pdf' target='_blank'>di sini</a>.</p>";
    ...
    echo "<p>Tutorial Pendaftaran Secara Elektronik elektronik, klik <a href='https://ecourt.mahkamahagung.go.id/' target='_blank'>di sini</a>.</p>";
    echo "</div>";
    echo "</div>";
