...
try {
    ...
    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        if ($data) {
            ...
            echo "<tbody>";
            echo "<tr>";
            echo "<td>" . htmlspecialchars($data['nama_lama_anak']) . "</td>";
            echo "<td>" . htmlspecialchars($data['nama_baru_anak']) . "</td>";
    ...
    echo "<ul>";
    echo "<li>Langkah 1: Siapkan dokumen persyaratan</li>";
    echo "<li>Langkah 2: Nasegel Dokumen di kantor POS</li>";
    echo "<li>Langkah 3: Pastikan dokumen sudah di-scan (termasuk Surat Gugatan)</li>";
    echo "</ul>";
